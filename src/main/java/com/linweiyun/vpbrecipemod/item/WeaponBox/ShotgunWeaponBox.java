...
import java.util.Random;
    ...
    public class ShotgunWeaponBox extends Item {

        public ShotgunWeaponBox(Properties pProperties) {
            super(pProperties);
        }
        Level level;
        Player player;
        ...
        public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
            ...
            switch (random.nextInt(7) + 1){
                case 1:
                    giveOriDropItem(new ItemStack(VPBRGunItem.M590_ITEM.get()));
                    break;
                case 2:
                    giveOriDropItem(new ItemStack(VPBRGunItem.M870_ITEM.get()));
                    break;
                case 3:
                    giveOriDropItem(new ItemStack(VPBRGunItem.SPAS12_ITEM.get()));
                    break;
                case 4:
                    giveOriDropItem(new ItemStack(VPBRGunItem.M1014_ITEM.get()));
                    break;
                case 5:
                    giveOriDropItem(new ItemStack(VPBRGunItem.AA12_ITEM.get()));
                    break;
                case 6:
                    giveOriDropItem(new ItemStack(VPBRGunItem.CITORICXS_ITEM.get()));
                    break;
                case 7:
                    giveOriDropItem(new ItemStack(VPBRGunItem.HS12_ITEM.get()));
                    break;
            }
