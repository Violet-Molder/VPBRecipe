...
public class SubGunWeaponBox extends Item {

    public SubGunWeaponBox(Properties pProperties) {
        super(pProperties);
    }
    Level level;
    Player player;
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        switch (random.nextInt(6) + 1){
            case 1:
                giveOriDropItem(new ItemStack(VPBRGunItem.MP5_ITEM.get()));
                break;
            case 2:
                giveOriDropItem(new ItemStack(VPBRGunItem.MP7_ITEM.get()));
                break;
            case 3:
                giveOriDropItem(new ItemStack(VPBRGunItem.MP7A2DEVGRU_ITEM.get()));
                break;
            case 4:
                giveOriDropItem(new ItemStack(VPBRGunItem.UMP45_ITEM.get()));
                break;
            case 5:
                giveOriDropItem(new ItemStack(VPBRGunItem.M950_ITEM.get()));
                break;
            case 6:
                giveOriDropItem(new ItemStack(VPBRGunItem.TMP_ITEM.get()));
                break;
        }
