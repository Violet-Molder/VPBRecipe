...
public class PistolWeaponBox extends Item {
    ...
    public PistolWeaponBox(Properties pProperties) {
        super(pProperties);
    }
    Level level;
    Player player;
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        switch (random.nextInt(7) + 1){
            case 1:
                giveOriDropItem(new ItemStack(VPBRGunItem.GLOCK17_ITEM.get()));
                break;
            case 2:
                giveOriDropItem(new ItemStack(VPBRGunItem.GLOCK18_ITEM.get()));
                break;
            case 3:
                giveOriDropItem(new ItemStack(VPBRGunItem.M9_ITEM.get()));
                break;
            case 4:
                giveOriDropItem(new ItemStack(VPBRGunItem.M1911A1_ITEM.get()));
                break;
            case 5:
                giveOriDropItem(new ItemStack(VPBRGunItem.TTI_VIPER_ITEM.get()));
                break;
            case 6:
                giveOriDropItem(new ItemStack(VPBRGunItem.P30L_ITEM.get()));
                break;
            case 7:
                giveOriDropItem(new ItemStack(VPBRGunItem.RHINO_ITEM.get()));
                break;
        }
